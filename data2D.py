...
time=list(file_time)
time=time[1:len(time)-2] #PROBLEME !!!
...
lev=np.linspace(0.,3200.,300)

plt.figure()
CS=plt.contourf(time[4:],altitude[7:116], PR2_LTA[7:116,4:],levels=lev,cmap='jet', extend='min')
plt.title("PR2_LTA")
plt.xlabel("time (UT)")
...
plt.figure()
CS=plt.contourf(time[4:],altitude[7:116], beta_aer_LTA2[7:116,4:],levels=lev,cmap='jet', extend='min')
