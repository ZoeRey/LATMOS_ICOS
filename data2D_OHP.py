...
lev=np.linspace(0.,1500.,20)
plt.figure()
plt.title("PR2_ICOS")
CS = plt.contourf(timemoy, altitude,datamoy,levels=lev,cmap='jet', extend='min')
...
lev=np.linspace(0.,56.,300)
plt.figure()
plt.title("PR2_ICOS")
CS = plt.contourf(timemoy[40:46], altitude[221:1315],datamoy[221:1315,40:46],levels=lev,cmap='jet', extend='min')
colobar=plt.colorbar(CS)
plt.xlabel('time (UT)')
...
lev=np.linspace(0.,0.0012,300)
plt.figure()
plt.title("beta_aer_ICOS")
CS = plt.contourf(timemoy[40:46],altitude[221:1315],beta_aer2[221:1315,40:46],levels=lev,cmap='jet', extend='min')
colobar=plt.colorbar(CS)
plt.xlabel('time (UT)')
plt.ylabel('altitude (km)')
plt.show()
